async function getData() {
  try {
    const response = await fetch("http://192.168.1.177:3000/test", {
...
async function makePost(token, title, detail) {
  try {
    const response = await fetch(
      "http://192.168.1.177:3000/auth/postOnCommunity",
      {
        method: "POST", // *GET, POST, PUT, DELETE, etc.
        mode: "cors", // no-cors, *cors, same-origin
        cache: "no-cache", // *default, no-cache, reload, force-cache, only-if-cached
...
async function makeComment(token, _id, comment) {
  try {
    const response = await fetch(
      "http://192.168.1.177:3000/auth/commentOnCommunity",
      {
        method: "POST", // *GET, POST, PUT, DELETE, etc.
        mode: "cors", // no-cors, *cors, same-origin
        cache: "no-cache", // *default, no-cache, reload, force-cache, only-if-cached
...
async function getAllPosts(token) {
  try {
    const response = await fetch("http://192.168.1.177:3000/auth/getAllPosts", {
...
async function getAllComments(token, _id) {
  try {
    const response = await fetch(
      "http://192.168.1.177:3000/auth/getAllComments",
      {
        method: "POST", // *GET, POST, PUT, DELETE, etc.
        mode: "cors", // no-cors, *cors, same-origin
        cache: "no-cache", // *default, no-cache, reload, force-cache, only-if-cached
...
function getTrails() {
  ...
  return fetch("http://192.168.1.177:3000/api/trails", { method: "GET" })
    .then((res) => {
...
async function deleteComment(token, comment) {
  try {
    const response = await fetch(
      "http://192.168.1.177:3000/auth/deleteCommentOnCommunityDetail",
      {
        method: "POST", // *GET, POST, PUT, DELETE, etc.
        mode: "cors", // no-cors, *cors, same-origin
        cache: "no-cache", // *default, no-cache, reload, force-cache, only-if-cached
...
async function editComment(token, comment) {
  try {
    const response = await fetch(
      "http://192.168.1.177:3000/auth/editCommentOnCommunityDetail",
      {
        method: "POST", // *GET, POST, PUT, DELETE, etc.
        mode: "cors", // no-cors, *cors, same-origin
        cache: "no-cache", // *default, no-cache, reload, force-cache, only-if-cached
